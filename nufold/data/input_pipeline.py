...
from nufold.data import data_transforms
...
def nonensembled_transform_fns(common_cfg, mode_cfg):
    ...
    if common_cfg.use_templates:
        ...
        if common_cfg.use_template_torsion_angles:
            transforms.extend(
                [
                    data_transforms.atom28_to_torsion_angles("template_"),
                ]
            )
    ...
    if mode_cfg.supervised:
        transforms.extend(
            [
                data_transforms.make_atom23_positions,
                data_transforms.atom28_to_frames,
                data_transforms.atom28_to_torsion_angles(""),
                data_transforms.make_pseudo_beta(""),
                data_transforms.get_backbone_frames,
                data_transforms.get_chi_angles,
                data_transforms.make_atom_p(""),
                data_transforms.make_atom_c4p(""),
                data_transforms.atom28_to_2d_angles,
            ]
        )
